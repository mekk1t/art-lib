        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DbGameId = table.Column<long>(type: "bigint", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Genres_Films_DbFilmId",
                        column: x => x.DbFilmId,
                        principalTable: "Films",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Genres_Games_DbGameId",
                        column: x => x.DbGameId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Genres_DbFilmId",
                table: "Genres",
                column: "DbFilmId");

            migrationBuilder.CreateIndex(
                name: "IX_Genres_DbGameId",
                table: "Genres",
                column: "DbGameId");
        }
